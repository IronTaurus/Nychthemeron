    ...
    mButton_Religion.onclick = function () { window.location.href = '../Religion.html' }
    ...
    mButton_History.onclick = function () { window.location.href = '../History.html' }
    ...
    mButton_Myths.onclick = function () { window.location.href = '../Myths.html' }
    ...
    mButton_Races.onclick = function () { window.location.href = '../Races.html' }
    ...
    mButton_Game.onclick = function () { window.location.href = '../Game.html' }
    ...
    mButton_Tools.onclick = function () { window.location.href = '../Tools.html' }
