...
mButton_Religion.onclick = function () {
  window.location.href = `${parentUrl}/Religion/Religion.html`;
};
...
mButton_History.onclick = function () {
  window.location.href = `${parentUrl}/History/History.html`;
};
...
mButton_Myths.onclick = function () {
  window.location.href = `${parentUrl}/Myths/Myths.html`;
};
...
mButton_Races.onclick = function () {
  window.location.href = `${parentUrl}/Races/Races.html`;
};
...
mButton_Game.onclick = function () {
  window.location.href = `${parentUrl}/Game/Game.html`;
};
...
mButton_Tools.onclick = function () {
  window.location.href = `${parentUrl}/Tools/Tools.html`;
};
