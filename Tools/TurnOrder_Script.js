...
function createCreature(id, noCreatures) {
  ...
  initNode = document.createTextNode("Initative: ");
  InitTitle.appendChild(initNode);
  var initBaseTxt = document.createElement("input");
  initBaseTxt.setAttribute("type", "text");
  initBaseTxt.setAttribute("id", "baseInitative");
  initBaseTxt.setAttribute("class", "txt");
  initBaseTxt.value = 0;
  var InitSeperator = document.createElement("h3");
  InitSeperator.setAttribute("type", "text");
  InitSeperator.setAttribute("class", "title");
  initSeperatorNode = document.createTextNode("| ");
  InitSeperator.appendChild(initSeperatorNode);
  ...
  initative.appendChild(initBaseTxt);
  initative.appendChild(InitSeperator);
